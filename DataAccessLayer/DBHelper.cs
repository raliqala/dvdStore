...
namespace DataAccessLayer
{
    class DBHelper
    {
        // private static string connString = ConfigurationManager.ConnectionStrings["DvdStoreDb"].ConnectionString;
        private static string connString = "server=TP; database=dvdStoreDB; Integrated Security=True";
